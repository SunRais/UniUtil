...
Subject.create(id: 3, name: "Sistemi Distribuiti e Mobili", cfu: "6", year: "1", semester: "1", description: "a", duration: "24", user_id: "2")
Subject.create(id: 4, name: "Constraint Programming", cfu: "6", year: "1", semester: "2", description: "a", duration: "24", user_id: "3")
Subject.create(id: 5, name: "Linguaggi e Traduttori", cfu: "6", year: "2", semester: "1", description: "a", duration: "24", user_id: "3")
Subject.create(id: 6, name: "Laboratorio di Programmazione Concorrente", cfu: "3", year: "1", semester: "1", description: "a", duration: "24", user_id: "1")
Subject.create(id: 7, name: "Fondamenti di Informatica Modulo A", cfu: "3", year: "1", semester: "1", description: "a", duration: "24", user_id: "3")
